...
year.2015.salaries <- year.2014.salaries + runif(100, -1000, 2500)

# Create a data.frame 'salaries' by combining the 3 vectors you just made
# Remember to set `stringsAsFactors=FALSE`!
employee.data <- data.frame(employees, year.2014.salaries, year.2015.salaries, stringsAsFactors=FALSE)

# Create a column 'raise' that stores the size of the raise between 2014 and 2015
employee.data$raise <- year.2015.salaries - year.2014.salaries
...
employee.57 <- employee.data[57, 3]

# How many employees got a raise?
amount.employees.with.raise <- employee.data[5, TRUE]
